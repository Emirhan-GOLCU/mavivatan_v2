...
#include "mavivatan_interfaces/msg/detail/ida_durum__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mavivatan_interfaces::msg::IdaDurum;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mavivatan_interfaces::msg::IdaDurum *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mavivatan_interfaces::msg::IdaDurum *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IdaDurum__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mavivatan_interfaces::msg::IdaDurum *>(
...
static size_t _IdaDurum__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_IdaDurum(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _IdaDurum__callbacks = {
...
static rosidl_message_type_support_t _IdaDurum__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IdaDurum__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mavivatan_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<mavivatan_interfaces::msg::IdaDurum>()
{
  return &mavivatan_interfaces::msg::typesupport_fastrtps_cpp::_IdaDurum__handle;
}
